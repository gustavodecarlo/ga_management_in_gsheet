...
function formatMetricSheet(createNew) {
  ...
  var formattingTypeCol = sheet.getRange("G2:G");
  var activeCol = sheet.getRange("J2:J");
  ...
  try {
    ...
    sheet.getRange("G1").setValue("Formatting Type");
    sheet.getRange("H1").setValue("Min");
    sheet.getRange("I1").setValue("Max");
    sheet.getRange("J1").setValue("Active");
